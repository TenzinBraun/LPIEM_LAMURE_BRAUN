...
private class FriendRepositoryImpl : FriendRepository{
    ...
    override fun getFriends(scope: CoroutineScope): LiveData<FriendResponse> {
        val data = MutableLiveData<FriendResponse>()
...
interface FriendRepository {
    ...
    fun getFriends(scope: CoroutineScope): LiveData<FriendResponse>
    companion object {
        /**
